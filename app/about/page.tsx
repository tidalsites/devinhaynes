  ...
  return (
    <div className=" min-h-screen grow bg-neutral-300 dark:bg-background">
      <div className="flex flex-col xl:grid xl:grid-cols-2 xl:grid-rows-[auto_1fr_auto] justify-between max-w-7xl gap-12 py-24 px-6 md:px-16">
        <div>
          <div>
            <h1 className="max-w-xs text-3xl font-semibold leading-10 tracking-tight mb-8">
              About Devin Haynes
            </h1>
          </div>
          <div className="flex flex-col gap-2 max-w-prose leading-8">
            ...
            <p>
              ...
              business needs. His work ranges from professional business
              websites and government contractor platforms to custom web
              applications and AI-powered interfaces.
            </p>
            <p>
